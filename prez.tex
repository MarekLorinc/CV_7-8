...
\title{Seriózne hry ako riešenie na následky mŕtvice
}

\date{\footnotesize 8. november 2020}
...
\section{Posledná časť}

\begin{frame}[fragile=singleslide]\frametitle{Nejaké odrážky}
...
\begin{frame}[fragile=singleslide]\frametitle{Ďaľšie odrážky}
\begin{itemize}
\item Hop
          \begin{itemize}
	\item Hip
...
\includegraphics[scale=.8]{graf.png}
